...
function Hero() {
    return (
        <div style={{ backgroundImage: 'url(/ZenoTrip/images/heroimg.png)' }} className='bg-cover bg-center lg:h-[710px] h-[1010px] flex items-center justify-center  text-white -mt-110 lg:-mt-40 p-4 relative'>
